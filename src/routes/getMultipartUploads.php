...
$app->post('/api/AmazonS3/getMultipartUploads', function ($request, $response, $args) {
    ...
    if(!empty($post_data['args']['maxUploads'])) {
        $body['MaxUploads'] = $post_data['args']['maxUploads'];
    }
    if(!empty($post_data['args']['prefix'])) {
        $body['Prefix'] = $post_data['args']['prefix'];
    }
    if(!empty($post_data['args']['uploadIdMarker'])) {
        $body['UploadIdMarker'] = $post_data['args']['uploadIdMarker'];
    }
