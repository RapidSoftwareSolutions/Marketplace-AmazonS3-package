...
$app->post('/api/AmazonS3/createBucket', function ($request, $response, $args) {
    
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','region','bucketName','bucketRegion']);
    ...
    $body['CreateBucketConfiguration']['LocationConstraint'] = $post_data['args']['bucketRegion'];
    ...
    try {
        $res = $client->createBucket($body)->toArray();
